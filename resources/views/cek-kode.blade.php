...
<body>
    <div class="container mt-3 mb-3">
        <div class="card">
            <img src="{{ asset('images/banner.png') }}" class="card-img-top" alt="Banner Image">
            <div class="card-body">
                @if(session('error'))
                <div class="alert alert-danger">{{ session('error') }}</div>
                @endif
                <h1 class="card-title">Cek Info</h1>
                <form action="{{ route('cek-kode.cek') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <a href="{{ route('formulir.create') }}" class="btn btn-secondary btn-block">Kembali ke Formulir</a>
