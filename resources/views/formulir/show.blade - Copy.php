                ...
                <div class="card border-info mb-1 mx-auto">
                    <div class="card-body">
                        ...
                        <div class="card border-info">
                            <div class="card-header">Hasil Pendaftaran Konsultasi</div>
                            <div class="card-body">
                                ...
                                @if ($zoom)
                                <hr>
                                <h5 class="card-title">Informasi Media Teleconference</h5>
                                ...
                                <a href="{{ route('formulir.create') }}" class="btn btn-primary mt-3" onclick="clearFormData()">Kembali ke Halaman Utama</a>
                            </div>
                        </div>
                    </div>
                </div>
